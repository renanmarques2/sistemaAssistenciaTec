...
public class RelatorioServico extends javax.swing.JInternalFrame {
    ...
    private void relatorio() {
        String sql = "SELECT tbos.os as OS, tbos.data_os as Data, tbos.tipo as Tipo,tbos.situacao as Situação,tbos.aparelho as Aparelho,tbos.valor as Valor,tbclientes.nomecli as Nome,tbclientes.cpfcli as CPF FROM tbos INNER JOIN tbclientes ON (tbclientes.idcliente = tbos.idcliente)";
        try {
    ...
    private void initComponents() {
        ...
        tblClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "OS", "Data", "Tipo", "Situação", "Aparelho", "Valor", "Nome", "CPF"
            }
        ) {
